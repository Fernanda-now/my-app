...
describe('<AddTask />', ()=>{
  ...
  describe('Success ', ()=>{
    ...
    it('renders the <AddTask/> quick overlay', ()=>{
      ...
      //expect(setShowQuickAddTask).toHaveBeeCalledTimes();
    });
    ...
    it('renders the <AddTask /> main when cancel is clicked', () => {
      ...
      fireEvent.click(queryByTestId('show-main-overlay'));
      expect(queryByTestId('add-task-main')).toBeFasly();
    });
    ...
    it('renders <AddTask /> and adds a task to the inbox', () =>{
      ...
      const setShowQuickAddTask = true;
      const setShowQuickAddTask = jest.fn(()=>!showQuickAddTask);
      const {queryByTestId}= render(
      <AddTask 
      ...
      expect(queryByTestId('add-task-content').value).toBe('I am a enw task and I am amazing!'
      );
    ...
    it('renders <AddTask /> and adds a task with a task date of TOMORROW', () => {
      ...
      expect(queryByTestId('task-date-overlay')).toBeTruthy();//here
